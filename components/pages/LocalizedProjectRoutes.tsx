...
const caseCopy = {
  en: {
    "residenziali/villa-acciaio-veneto": {
      ...
      body: [
        "This villa combines innovation, efficiency and contemporary design. The steel structure delivers strength, durability and sustainability, applying advanced engineering to a residential setting.",
        "The project shows how structural design can work in direct dialogue with architecture to create a functional building that fits naturally into its landscape.",
      ],
      bullets: [
        ["Steel structure", "strength, lightness and reduced construction time."],
        ["Integrated design", "spaces optimised for comfort and landscape integration."],
        ["Sustainability", "high energy performance and strong environmental standards."],
      ],
    },
    "residenziali/villa-acciaio-salsomaggiore": {
      heading: "Steel villa - Salsomaggiore Terme (PR)",
      body: [
        "Studio Capoferri handled the structural scope of a steel residential building in Salsomaggiore Terme, from design through construction.",
        "Because of weak ground conditions, the project required piled foundations coordinated from the outset with a mixed reinforced-concrete and steel superstructure.",
      ],
      bullets: [
        ["Piled foundations", "a targeted solution for poor soil conditions."],
        ["Steel frame", "beams and columns defining the building with precision and lightness."],
        ["Dry construction systems", "high-density mineral wool walls for speed and thermal performance."],
    ...
    "industriali/capannone-erbusco": {
      ...
      body: [
        "Studio Capoferri managed the structural, architectural and planning design for the extension of the production area of a major heavy steel fabrication company in Erbusco.",
        "The building was conceived for heavy loads and complex workflows, with a structural system designed to support demanding industrial use.",
      ],
      bullets: [
        ["Steel primary structure", "strength and reliability for an industrial environment."],
        ["Executive design", "shop drawings for steel fabrication and assembly."],
        ["Crane integration", "structure designed for two overhead travelling cranes."],
        ["Envelope efficiency", "sandwich panels for thermal and acoustic insulation."],
      ],
    },
    "industriali/ampliamento-complesso-zootecnico": {
      heading: "Livestock complex extension",
      body: [
        "Work on existing buildings requires balance between structural constraints, logistics and business continuity. In this livestock complex extension, the aim was to increase covered area while maintaining maximum internal flexibility.",
        "The solution focused on new steel trusses spanning almost 16 metres, eliminating intermediate supports and improving functional use of the space.",
      ],
      bullets: [
        ...
        ["Integration", "precise connection between new works and existing structures."],
      ],
    },
    "industriali/centro-direzionale-provaglio-diseo": {
      heading: "Office centre - Provaglio d'Iseo",
      body: [
        "After an extensive preliminary and technical development phase, this refurbishment moved into site execution. The intervention transforms an industrial building into a new office centre with offices, laboratories and workspaces in Provaglio d'Iseo.",
        "Our contribution focused on a full optimisation of the original scheme, adapting it to the real construction dynamics of the site and to the execution logic of a major steel mezzanine.",
      ],
      bullets: [
        ["Structural and geometric optimisation", "of the steelwork package."],
        ["Coordination", "with the conditions of the existing building."],
        ["Executive detailing", "for fabrication and production."],
        ["Assembly sequencing", "rationalised to keep the site workflow efficient."],
      ],
    },
    "ricettivi/superstudio-village": {
      heading: "Superstudio Village - Milan Bovisa",
      body: [
        "The structural design activity concerned a building complex in Milan Bovisa for Superstudio Events, composed of six buildings with different intervention types.",
        "Works started in 2023 and included vault and roof strengthening, demolition and reconstruction with a new steel structure up to around 16 metres high, mixed reinforced-concrete and masonry rebuilding, and seismic upgrading of an existing building.",
      ],
      bullets: [],
    },
    "ricettivi/superstudio-maxi": {
      ...
      body: [
        "This structural intervention involved the recovery of a disused industrial shed in the Famagosta area of Milan, formerly used for steel fabrication.",
        "The building was converted into an event venue and upgraded through seismic strengthening, consolidation of the existing steel structures and new steel additions for congress, exhibition and multimedia functions.",
      ],
      bullets: [],
    },
  },
