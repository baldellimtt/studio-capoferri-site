    ...
    <main id="main-content" className="section-shell bg-[#fafbfc]">
      <div className={layoutGutterXClass}>
        ...
        <div className="space-y-5 sm:space-y-8">
          <div className="frost-card rounded-2xl p-4 sm:p-6">
            <h3 className="mb-3 font-semibold text-[#2a3f54]">Cookie tecnici (necessari)</h3>
            <p className={`mb-3 ${ui.body}`}>
          ...
          <div className={`rounded-2xl p-4 sm:p-6 ${ui.brandGradientCompact} text-white`}>
